...
const LoginPage = () => {
  ...
  const { login, error, resetEmailSent, forgotPassword, clearErrors, clearResetStatus } = useAuth();
        ...
        {forgotPasswordMode ? (
          <form className="mt-8 space-y-6" onSubmit={handleResetPassword}>
            <div className="form-group">
              <label htmlFor="reset-email" className="form-label">{t('personal.email')}</label>
              <input
                id="reset-email"
                name="reset-email"
                type="email"
