            ...
            message={
              error.includes('create an account first') ? (
                <span className="flex flex-col space-y-2">
                  ...
                  <span className="block text-center mt-2 p-2 rounded-md">
                    <Link 
                      to="/register" 
                      className="flex items-center justify-center gap-2 bg-primary-600 hover:bg-primary-700 text-white font-bold py-3 px-4 rounded-lg shadow-md hover:shadow-lg transition-all duration-200"
                    >
